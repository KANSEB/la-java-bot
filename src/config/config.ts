...
export const SALONS = {
  ...
  hebergement: "⛺・hebergement-camping",
...
export const STRUCTURE: CategorieDef[] = [
  ...
  },
  {
    ...
    salons: [
      ...
      {
        cle: "covoiturage", type: "forum", sujet: "Propose ou cherche un covoit' pour La Java",
        tags: ["Je propose", "Je cherche", "Départ Paris", "Départ Quimper", "Départ Rennes", "Départ Nantes", "Complet"],
      },
      { cle: "hebergement", type: "texte", sujet: "Camping, logement, bons plans autour du site" },
